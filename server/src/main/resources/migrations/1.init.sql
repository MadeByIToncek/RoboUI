-- migration_id definition
CREATE TABLE `migration_id` (`last_applied_migration` int(11) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf16 COLLATE=utf16_czech_ci;
-- teams definition
...
INSERT INTO robosoutez.migration_id (last_applied_migration) VALUES(1);